      ...
      <aside  v-show="sideBar" class="fixed top-0 left-0 z-40 w-64 h-screen animate-sidebar" aria-label="Sidebar">
        <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 ">
            <a href="" class="flex items-center ps-2.5 mb-5">
                ...
                <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Inventaris Product</span>
            </a>
            <ul class="space-y-2 font-medium">
                ...
                <li>
                  <router-link :to="{ name: 'product' }" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <span class="inline-flex items-center justify-center px-2 ms-3 text-sm font-medium text-gray-800 bg-gray-100 rounded-full dark:bg-gray-700 dark:text-gray-300">add</span>
                  </router-link>
                </li>
                <li>
