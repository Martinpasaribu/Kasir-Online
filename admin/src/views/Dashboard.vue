                        ...
                        <div class="flex flex-col items-center justify-center h-46 rounded bg-gray-50 dark:bg-gray-800">
                            ...
                            <div class="flex justify-between pb-4 mb-4 border-b border-gray-200 dark:border-gray-700">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm font-normal text-gray-500 dark:text-gray-400">Product Available</p>
                                </div>
                                </div>
                                <div>
                                <span class="bg-green-100 text-green-800 text-xs font-medium inline-flex items-center px-2.5 py-1 rounded-md dark:bg-green-900 dark:text-green-300">
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700 p-3 rounded-lg">
                                <div class="grid grid-cols-3 gap-3 mb-2">
                                    ...
                                    <dl class="bg-teal-50 dark:bg-gray-600 rounded-lg flex flex-col items-center justify-center h-[78px]">
                                        ...
                                        <dd class="text-teal-600 dark:text-teal-300 text-sm font-medium">Jumlah Stok</dd>
                                    </dl>
    ...
    methods: {
        ...
        async getSummary(){
            try {
                ...
                const errorMessage = error.response?.data?.message || "Gagal Load Data Summary.";
